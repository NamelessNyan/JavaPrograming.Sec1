...
public class lab604 {
	...
	{
		if(sub_id.substring(1,2).equals("21")&&sub_id.substring(5).equals("1"))
		{
			return true;
		}
		else
	...
	public static void displayData(boolean sid,boolean subid)
	{
		if(sid)
		{
			System.out.println("sudent Id: "+studentId+" 1st year student in IT");
		}
		else
		{
			System.out.println("sudent Id: "+studentId+" is not 1st year student in IT");
		}
		if(sid)
		{
